...
class OrderCreator(object):
    ...
    def create_order_from_basket(self, basket):
        order_collection, created = ProductOrderCollection.objects.get_or_create(pk=basket.data.get('order_collection'))
        ...
        for line in basket.lines:
            ...
            if line.type == 4:
                # a discount line
                campaign = Campaign.objects.get(pk=line.campaign_id)
                order_collection.add_discount(campaign=campaign, code=line.code)
