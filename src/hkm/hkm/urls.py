...
urlpatterns = [
  ...
  url(r'^record/(?P<finna_id>[a-zA-Z0-9:.]+)/$', views.FinnaRecordDetailView.as_view(), name='hkm_record'),
  url(r'^record/(?P<finna_id>[a-zA-Z0-9:.]+)/feedback/$', views.FinnaRecordFeedbackView.as_view(), name='hkm_record_feedback'),
